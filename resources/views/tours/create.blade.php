    ...
    <div class="max-w-2xl mx-auto p-4 bg-white sm:p-6 lg:p-8">
        <form method="POST" action="{{ route('tours.store') }}">
            ...
            <div>
                ...
                <x-text-input id="image_link" class="block mt-1 w-full" type="text" name="image_link" :value="old('image_link')"
                    required autofocus />
            ...
            <div class="flex flex-col sm:flex-row sm:gap-4">
                ...
                <div class="mt-4 flex-auto">
                    ...
                    <x-text-input type="number" id="price_per_passenger" class="block mt-1 w-full"
                        name="price_per_passenger" :value="old('price_per_passenger')" required step="0.01" />
                ...
                <div class="mt-4 flex-auto">
                    ...
                    <x-select id="status" class="block mt-1 w-full" name="status" required :options="App\Enum\TourStatusEnum::getSelectOptions()"
                        :selected="old('status', App\Enum\TourStatusEnum::UNDER_MAINTENANCE->value)" />
